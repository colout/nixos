...
# and in the NixOS manual (accessible by running ‘nixos-help’).
{
  ...
  systemd.services.local-ai-web-stack = {
    ...
    serviceConfig = {
      ...
      ExecStart = ''/run/current-system/sw/bin/docker compose pull -f /home/colout/git/local-ai-web-stack/docker-compose.yaml; /run/current-system/sw/bin/docker compose -f /home/colout/git/local-ai-web-stack/docker-compose.yaml up'';
